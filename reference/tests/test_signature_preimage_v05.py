...
class SignaturePreimageV05Tests(unittest.TestCase):
    ...
    def test_each_security_binding_changes_exact_preimage(self):
        ...
        self.assertNotEqual(baseline, self.preimage(content_schema="AIFC/target-evidence/v1"), "CONTENT_SCHEMA_REBINDING")
        self.assertNotEqual(baseline, self.preimage(protocol_version="1.0-other"), "CROSS_PROTOCOL_SIGNATURE_REPLAY")
