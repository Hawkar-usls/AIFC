...
class SignaturePreimageGateV05Tests(unittest.TestCase):
    def test_v105_is_exact_two_class_extension_of_v104(self):
        ...
        added = set(current_ids) - set(previous_ids)
        removed = set(previous_ids) - set(current_ids)
    ...
    def test_preimage_spec_and_policy_are_frozen_inputs_not_crypto_claims(self):
