#!/usr/bin/env python3
"""AIFC Verifier A self-auditing standalone replay CLI v0.3."""
...
def parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="aifc-verify-v03",
        description=(
            "Resolve exact evidence bytes, enforce runtime Draft 2020-12 schemas, "
            "replay plan/trial semantics, and run the current pre-crypto AIFC evidence engine."
        ),
    )
