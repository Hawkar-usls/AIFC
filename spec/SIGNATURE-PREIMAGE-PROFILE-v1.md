...
Historical pre-v0.5 `AIFC/experiment-plan/v1` objects remain readable by their legacy verifier entry points. Absence of `signature_preimage_policy_hash` can never satisfy the v0.5 strongest-grade signature-preimage gate.
...
It derives them from content-addressed evidence:
